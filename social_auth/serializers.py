...
from social_auth import twitterhelper
...
class GoogleSocialAuthSerializer(serializers.Serializer):
    ...
    def validate_auth_token(self, auth_token):
        ...
        try:
            ...
            print('KeyError: sub not found in user_data')  # Debugging log
        ...
        print(f"User data: user_id={user_id}, email={email}, name={name}, provider={provider}")  # Debugging log
